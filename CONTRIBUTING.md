...
If unique, [open an issue](https://github.com/kleister/homebrew-kleister/issues) and answer the questions so we can understand and reproduce the problematic behavior.
